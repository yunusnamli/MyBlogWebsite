<%@ Page Title="" Language="C#" MasterPageFile="~/Anasayfa.Master" AutoEventWireup="true" CodeBehind="teknoloji6.aspx.cs" Inherits="kisiselblogsitem.teknoloji6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:Repeater ID="teknolojik6" runat="server">
        <ItemTemplate>

   <div class="teknolojik_icerik_dis">          
          <div class="teknolojik_icerik_baslik" style="margin-left:50px;"><p style="font-size: 25px; font-weight:bold; font-family:system-ui; color:#19191a; margin: 0px; "><%#Eval("baslik")%></p></div>
