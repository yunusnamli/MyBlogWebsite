<%@ Page Title="" Language="C#" MasterPageFile="~/Anasayfa.Master" AutoEventWireup="true" CodeBehind="blog3.aspx.cs" Inherits="kisiselblogsitem.blog3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

   <asp:Repeater ID="blog_3" runat="server">
        <ItemTemplate>

   <div class="blog_icerik_dis">          
          <div class="blog_icerik_baslik" style="margin-left:-5px;"><p style="font-size: 25px; font-weight:bold; font-family:system-ui; color:#19191a; margin: 0px; "><%#Eval("blog_baslik")%></p></div>
